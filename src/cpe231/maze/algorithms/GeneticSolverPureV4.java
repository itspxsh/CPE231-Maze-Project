...
public class GeneticSolverPureV4 implements MazeSolver {

    // TUNED PARAMETERS: Balanced "Brute Force"
    ...
    private static final int ELITISM_COUNT = 35; // Higher protection for best paths
    ...
    public AlgorithmResult solve(MazeContext context) {
        ...
        return new AlgorithmResult("GeneticPureV4", bestSolution.path, bestSolution.cost, System.nanoTime() - startTime, nodesExpanded);
    }
