...
public class GeneticSolverV10 implements MazeSolver {
    ...
    // Always keep Elitism relatively high to protect the best paths found so far
    private static final double ELITISM_RATE = 0.15; // Keep top 75 (15% of 500)

    private static final int[] DR = {-1, 1, 0, 0};
    private static final int[] DC = {0, 0, -1, 1};

    // ... (Keep Inner Class 'Individual' same as Genetic.java) ...
    // ... (Keep 'isValid', 'calculateCost', 'reconstructPath' same as Genetic.java) ...
    ...
    public AlgorithmResult solve(MazeContext context) {
        ...
        for (int gen = 0; gen < MAX_GENERATIONS; gen++) {
            ...
            // --- 🚀 THE FIX: DYNAMIC ADAPTATION ---
            // Calculate mutation rate based on progress
            // At Gen 0: Rate is 0.2 (Explores like V1)
            // At Gen 1000: Rate is 0.02 (Stabilizes like Genetic)
            ...
            // 1. Elitism (Keep the best, don't let mutation destroy them)
    ...
    // ... (Copy 'initializePopulation', 'selectParent', 'crossover', 'mutate' from Genetic.java) ...
    // Note: Use the 'mutate' logic from Genetic.java (BFS Shortcut), it is cleaner.
