...
public class GA implements MazeSolver {

    // --- GA Parameters Settings (Adjusted for Requirements) ---
    private static final int POPULATION_SIZE = 50;   
    private static final int MAX_GENERATIONS = 200;  
    // Crossover 80-90% กำลังสวยสำหรับ Pathfinding
    private static final double CROSSOVER_RATE = 0.9; 
    // ปรับให้เข้าเกณฑ์ (แนะนำ 2-5% พอครับ 5% คือ Maximum ของโจทย์แล้ว)
    private static final double MUTATION_RATE = 0.05; 
    // Elitism คำนวณตามสูตรโจทย์: 1 - Crossover = 0.1 (10%)
